    ...
    <div class="row">
        ...
        <div class="col-2 mt-5 mb-3 clearfix">
            <ul class="nav flex-column nav-pills justify-content-center">
                <li class="nav-item">
                    <a class="nav-link active" href="#">Farmacias</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Farmacias</h2>
                        <?php
                        //Add button just for admin
                        if ($_SESSION["role_id"] === ROLE_ADMIN) {
                            echo '<a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Nueva Farmacia</a>';
                        }
                        ?>
                    </div>
                    <?php

                    //Query para obtener todas las farmacias
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        ...
                        echo "Hubo un error al obtener las farmacias.";
                    }
                    mysqli_close($link);
                    ?>
                </div>
